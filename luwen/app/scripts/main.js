;(function (window) {
  ...
  let texts = ['想要大声告诉你','我每天都在努力','就是为了将来','依然能见到你','你是否会','因此而在意','不敢奢求','生活在那一秒停留','我会铭记某时某刻的那个你','想要大声告诉你','我每天都在加倍努力','为了能在你心中占有一席之地','你是否会因此而在意','不敢预见','为此每时每刻都在逃避','我相信自己','经过不断努力','终有一天会打动你','在见你的每一天里','生活时刻充满生机','在有你的每一天里','心情更是异常美丽','悸动的心跳也在这时会意','而你曾否知我心意','我喜欢你 这不是吹嘘','我喜欢你更非只想试试而已','TO:璐雯 BY:恺']
